<?php
	...
	Class datasourcesearch_index extends Datasource{
		...
		public function grab(&$param_pool) {
			...
			$per_page = isset($_GET['per-page']) ? (int)$_GET['per-page'] : $this->dsParamLIMIT;
			$sort = isset($_GET['sort']) ? $_GET['sort'] : 'score';
			$direction = isset($_GET['direction']) ? strtoupper($_GET['direction']) : 'DESC';
